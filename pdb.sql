...
SQL> CREATE PLUGGABLE DATABASE pdb1
  2     ADMIN USER jo IDENTIFIED BY joy;
...
SQL> CREATE USER jojo_plsqlauca IDENTIFIED BY joy;

User created.

-- Grant all privileges to the newly created user
SQL> GRANT all privileges to jojo_plsqlauca;
...
-- Drop the pluggable database jojo_to_delete_pdb including its datafiles
SQL> DROP PLUGGABLE DATABASE jojo_to_delete_pdb INCLUDING DATAFILES;
